...
#Copy your generated text file (e.g. output1.txt) and the instructor file (e.g., inst_out1.txt)
#to diffchecker.com to compare.
...
p1 = subprocess.check_call(['python',"triangle.py"],stdin=myinput,stdout=myoutput)
